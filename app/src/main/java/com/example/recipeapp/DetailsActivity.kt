...
data class RecipeClass(val name: Array<String>, val steps: Array<String>, val ingredients: Array<String>)
...
class DetailsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val ingredients: Array<String> = intent.getStringArrayExtra("ingredients") as Array<String>
